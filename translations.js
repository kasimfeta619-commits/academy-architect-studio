const translations = {
    "bg": {
        ...
        // Позиции в екипа (Роли на български)
        "role-manager": "Управител",
        "role-lead_architect": "Главен архитект",
        "role-architect": "Архитект",
        "role-intern_architect": "Стажант-архитект",
        "role-designer": "Дизайнер",
        "role-structural_engineer": "Инженер-конструктор",
        "role-road_engineer": "Пътен инженер",
        "role-plumbing_engineer": "Експерт ВиК",
        "role-electrical_engineer": "Експерт ЕЛ",
        "role-hvac_engineer": "Експерт ОВК",
        "role-landscape_architect": "Ландшафтен архитект",
        "role-geodesist": "Геодезист",
        "role-drafter": "Чертожник",
        "role-cost_estimator": "Бюджетчик / К.С.С.",
        "role-project_manager": "Ръководител проекти",
